...
!1)}},q={setValueForSection:function(c,b,e){k(c,b);a(c).find(".hTextsActions .hTextsActionButton").each(function(){a(this).data("id")!==e&&a(this).prop("disabled","disabled")})},setValue:function(c,b){"string"===typeof b&&(b=JSON.parse(b));for(var e in b){var d=b[e],f;for(f in d.data){var g=d.data[f];if(g){var k=c,r=d.id,m=d.name,n=d.code,p=d.required,q=d.position,t=a(k).find('.hTextsData ul.hSections li.hItemSection[data-id="'+r+'"]').first();0===t.length&&(t=w(k,r,m,n,p,q));t.find("ul.hTexts").append(x(k,
r,g))}}}},setDisabled:function(c,d){!0===d||"true"===d||1===d||"1"===d?(a(c).attr("data-disabled","disabled"),a(c).find(".hTextsActions .hTextsActionButton").prop("disabled","disabled"),a(c).find(".hTextsData button.hTextsEditButton").prop("disabled","disabled"),a(c).find(".hTextsData button.hTextsDeleteButton").prop("disabled","disabled"),"ckeditor"===b.textEditorType?SetCkEditorReadonly(b.tagId+"_hValue",!0):a(c).find(".hTextsInput #"+b.tagId+"_hValue").prop("disabled","disabled"),b.sortableTexts&&
a(c).find(".hTextsData ul.hSections ul.hTexts").sortable("option","disabled",!0),b.sortableSections&&a(c).find(".hTextsData ul.hSections").sortable("option","disabled",!0)):!1===d||"false"===d||0===d||"0"===d?(a(c).attr("data-disabled",""),a(c).find(".hTextsActions .hTextsActionButton").prop("disabled",!1),a(c).find(".hTextsData button.hTextsEditButton").prop("disabled",!1),a(c).find(".hTextsData button.hTextsDeleteButton").prop("disabled",!1),"ckeditor"===b.textEditorType?SetCkEditorReadonly(b.tagId+
"_hValue",!1):a(c).find(".hTextsInput #"+b.tagId+"_hValue").prop("disabled",!1),b.sortableTexts&&a(c).find(".hTextsData ul.hSections ul.hTexts").sortable("option","disabled",!1),b.sortableSections&&a(c).find(".hTextsData ul.hSections").sortable("option","disabled",!1)):console.log("Invalid setDisabled value ["+d+"]!")}};if("string"===typeof f)if(q[f]){g=Array.prototype.slice.call(arguments,1);g.unshift(this);if(b=a(this).data("_NetopesHierarchicalTextsConfig"))return q[f].apply(this,g);console.log("Invalid NetopesHierarchicalTexts instance for element ["+
a(this).attr("id")+"]!")}else console.log("Invalid or inaccessible method: ["+f+"]!");else{var y="object"===typeof f?a.extend(g,f):g;return this.each(function(){e(this,y)})}}})(jQuery);
