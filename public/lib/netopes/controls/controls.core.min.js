...
function SetFieldErrorClass(a,b,c){if(!a)return!1;c=c?c:"clsFieldError";a=$(a);b?b=!0:(b=a.hasClass("clsNumericTextBox")?0!==GetNumericTextBoxValue(a):a.hasClass("clsSmartComboBox")?!!GetSmartCBOValue(a.attr("id")):a.val()&&0<a.val().length,a.hasClass("clsCkEditor")&&(a=a.parent().find("#cke_"+a.attr("id")+" .cke_contents .cke_wysiwyg_div")));b?(a.removeClass(c),a.hasClass("clsSmartComboBox")&&a.data("select2").$selection.removeClass(c)):(a.addClass(c),a.hasClass("clsSmartComboBox")&&a.data("select2").$selection.addClass(c));
