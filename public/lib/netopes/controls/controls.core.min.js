...
(function(a){a.fn.imageCheckBoxCheck=function(){this.filter('input[type="image"]').each(function(){a(this).val(1);a(this).trigger("change")});return this};a.fn.imageCheckBoxUncheck=function(){this.filter('input[type="image"]').each(function(){a(this).val(0);a(this).trigger("change")});return this};a.fn.imageCheckBoxToggle=function(){this.filter('input[type="image"]').each(function(){"1"===a(this).val()?a(this).val(0):a(this).val(1);a(this).trigger("change")});return this}})(jQuery);
