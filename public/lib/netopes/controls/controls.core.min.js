...
function InitTCBOFancyTree(a,b,c,d,e,f,g,k,l,h){if(a&&0!==a.length){var m=encodeURIComponent(b),n=xAppWebLink+"/aindex.php?namespace="+f;b="";l=l?"&hpc=1":"";if(g||0<g.length)b+="&uid="+g;g="";if("object"===typeof e)for(var p in e)g+="&"+p+"="+e[p];else"string"===typeof e&&(g=e);n=1===k||!0===k?n+("&arhash="+encodeURIComponent(GibberishAES.enc("module="+c+"&method="+d+g+l+b+"&phash="+window.name,"xJS"))):n+("&module="+c+"&method="+d+g+l+b+"&phash="+window.name);$("#"+a+"-ctree").fancytree({checkbox:!0,
icon:h||!1,selectMode:1,clickFolderMode:1,debugLevel:0,source:{url:n+"&type=json&tree=1&val="+m},lazyLoad:function(a,b){b.result={url:n+"&type=json&tree=1&val="+m,data:{key:b.node.key}}},createNode:function(a,b){if(!b.node.data.hasSelectedChild)return!1;$.ajax({url:n+"&type=json&tree=1&val="+m,data:{key:b.node.key},dataType:"json",success:function(a){b.node.addChildren(a)}})},select:function(b,c){c.node.isSelected()?(TCBOSetValue(a,c.node.key,c.node.title,!1),CBODDBtnClick(a)):TCBOSetValue(a,"","",
!1)}})}}
function InitFancyTree(a,b,c,d,e,f,g,k,l){if(a&&0!==a.length){var h=xAppWebLink+"/aindex.php?namespace="+e;e="";k=k?"&hpc=1":"";if(f||0<f.length)e+="&uid="+f;f="";if("object"===typeof d)for(var m in d)f+="&"+m+"="+d[m];else"string"===typeof d&&(f=d);h=1===g||!0===g?h+("&arhash="+encodeURIComponent(GibberishAES.enc("module="+b+"&method="+c+f+k+e+"&phash="+window.name,"xJS"))):h+("&module="+b+"&method="+c+f+k+e+"&phash="+window.name);$("#"+a+"-ctree").fancytree({checkbox:!0,icon:l||!1,selectMode:1,clickFolderMode:1,
...
function DestroyCkEditors(a,b){if(b&&0!=b.length&&(a=$("#"+b))){var c=window.ckei_list;if(void 0!=c&&null!=c&&"object"==typeof c&&0!=c.length){b=[];for(var d=0;d<c.length;d++){var e=!1;a.find("#"+c[d]).each(function(){var a=CKEDITOR.instances[c[d]];a&&a.destroy(!0);e=!0});e||b.push(c[d])}window.ckei_list=b}}}
function DestroyCkEditor(a,b,c){if(b)if(c)for(c=b.split(","),b=0;b<c.length;b++)DestroyCkEditor(a,c[b],!1);else a=window.ckei_list,(c=CKEDITOR.instances[b])&&c.destroy(!0),void 0!=a&&null!=a&&"object"==typeof a&&-1!=$.inArray(b,a)&&(a.splice(a.indexOf(b),1),window.ckei_list=a);else if(a=window.ckei_list,void 0!=a&&null!=a&&"object"==typeof a&&0!=a.length){for(b=0;b<a.length;b++)(c=CKEDITOR.instances[a[b]])&&c.destroy(!0);window.ckei_list=[]}}
