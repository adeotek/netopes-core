...
function InitTCBOFancyTree(a,b,c,d,e,f,g,m,k,n){if(a&&0!==a.length){var h=encodeURIComponent(b),l=nAppBaseUrl+"/aindex.php?namespace="+f;b="";k=k?"&hpc=1":"";if(g||0<g.length)b+="&uid="+g;g="";if("object"===typeof e)for(var p in e)g+="&"+p+"="+e[p];else"string"===typeof e&&(g=e);l=1===m||!0===m?l+("&arhash="+encodeURIComponent(GibberishAES.enc("module="+c+"&method="+d+g+k+b+"&phash="+window.name,"xJS"))):l+("&module="+c+"&method="+d+g+k+b+"&phash="+window.name);$("#"+a+"-ctree").fancytree({checkbox:!0,
...
function DestroyCkEditors(a,b){if(b&&0!=b.length&&(a=$("#"+b))){var c=window.ckei_list;if(void 0!=c&&null!=c&&"object"==typeof c&&0!=c.length){b=[];for(var d={$jscomp$loop$prop$i$4:0};d.$jscomp$loop$prop$i$4<c.length;d={$jscomp$loop$prop$i$4:d.$jscomp$loop$prop$i$4,$jscomp$loop$prop$dropped$5:d.$jscomp$loop$prop$dropped$5},d.$jscomp$loop$prop$i$4++)d.$jscomp$loop$prop$dropped$5=!1,a.find("#"+c[d.$jscomp$loop$prop$i$4]).each(function(a){return function(){var b=CKEDITOR.instances[c[a.$jscomp$loop$prop$i$4]];
b&&b.destroy(!0);a.$jscomp$loop$prop$dropped$5=!0}}(d)),d.$jscomp$loop$prop$dropped$5||b.push(c[d.$jscomp$loop$prop$i$4]);window.ckei_list=b}}}
