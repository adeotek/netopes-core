...
function ShowLoader(a,b){"object"!=typeof a&&$("#"+a);0<$(obj).length&&(1!==b&&!0!==b&&"1"!==b||$(obj).css("height",Math.max($(document).outerHeight(),window.innerHeight)+"px"),$(obj).show())}function HideLoader(a){"object"!=typeof a&&$("#"+a);0<$(obj).length&&$(obj).hide()}function OpenUrl(a,b){if(!a)return!1;!0===b||1===b||"1"===b?(window.open(a,"_blank"),window.focus()):window.open(a)}
...
(a=$("#"+a).attr("data-onchange"))&&0<a.length&&eval(a)}function TCBOSetValue(a,b,c,d){if($("#"+a).attr("disabled"))return!1;var e=$("#"+a).val();$("#"+a).val(b);var f=$("#"+a+"-cbo");$(f).val(c);$(f).attr("data-value",b);if(1==d||1==d)b=$("#"+a+"-ctree").fancytree("getTree").getNodeByKey(e),null!=b&&b.setSelected(!1);(a=$("#"+a).attr("data-onchange"))&&0<a.length&&eval(a)}
function InitTCBOFancyTree(a,b,c,d,e,f,g,m,k,n){if(a&&0!==a.length){var h=encodeURIComponent(b),l=xAppWebLink+"/aindex.php?namespace="+f;b="";k=k?"&hpc=1":"";if(g||0<g.length)b+="&uid="+g;g="";if("object"===typeof e)for(var p in e)g+="&"+p+"="+e[p];else"string"===typeof e&&(g=e);l=1===m||!0===m?l+("&arhash="+encodeURIComponent(GibberishAES.enc("module="+c+"&method="+d+g+k+b+"&phash="+window.name,"xJS"))):l+("&module="+c+"&method="+d+g+k+b+"&phash="+window.name);$("#"+a+"-ctree").fancytree({checkbox:!0,
icon:n||!1,selectMode:1,clickFolderMode:1,debugLevel:0,source:{url:l+"&type=json&tree=1&val="+h},lazyLoad:function(a,b){b.result={url:l+"&type=json&tree=1&val="+h,data:{key:b.node.key}}},createNode:function(a,b){if(!b.node.data.hasSelectedChild)return!1;$.ajax({url:l+"&type=json&tree=1&val="+h,data:{key:b.node.key},dataType:"json",success:function(a){b.node.addChildren(a)}})},select:function(b,c){c.node.isSelected()?(TCBOSetValue(a,c.node.key,c.node.title,!1),CBODDBtnClick(a)):TCBOSetValue(a,"","",
!1)}})}}
function InitFancyTree(a,b,c,d,e,f,g,m,k,n){if(a&&0!==a.length){var h=xAppWebLink+"/aindex.php?namespace="+e;e="";k=k?"&hpc=1":"";if(f||0<f.length)e+="&uid="+f;f="";if("object"===typeof d)for(var l in d)f+="&"+l+"="+d[l];else"string"===typeof d&&(f=d);h=1===g||!0===g?h+("&arhash="+encodeURIComponent(GibberishAES.enc("module="+b+"&method="+c+f+k+e+"&phash="+window.name,"xJS"))):h+("&module="+b+"&method="+c+f+k+e+"&phash="+window.name);$("#"+a).fancytree({checkbox:m||!1,icon:n||!1,selectMode:1,clickFolderMode:1,
debugLevel:0,source:{url:h+"&type=json&tree=1"},lazyLoad:function(a,b){b.result={url:h+"&type=json&tree=1",data:{key:b.node.key}}},createNode:function(a,b){if(!b.node.data.hasSelectedChild)return!1;$.ajax({url:h+"&type=json&tree=1",data:{key:b.node.key},dataType:"json",success:function(a){b.node.addChildren(a)}})},click:function(a,b){$.event.trigger({type:"fancyTree.onclick",event:a,data:b})},dblclick:function(a,b){$.event.trigger({type:"fancyTree.ondblclick",event:a,data:b})},select:function(a,b){$.event.trigger({type:"fancyTree.onselect",
event:a,data:b})}})}}$(document).on("keydown","input.clsGridComboBox[type=text]",function(a){if($("#"+$(this).attr("data-id")).attr("disabled"))return a.preventDefault(),!1;13===a.keyCode?(a=$(this).attr("data-id"),$("#"+a+"-dropdown").attr("data-reload",1),GCBODDBtnClick(a,1)):27===a.keyCode?(a.preventDefault(),GCBODDBtnClick($(this).attr("data-id"),0)):(a.altKey&&(40===a.keyCode||98===a.keyCode)||115===a.keyCode)&&GCBODDBtnClick($(this).attr("data-id"),null)});
...
function SmartCBOInitialize(){$("select.SmartCBO").each(function(a,b){if(!$(b).hasClass("select2-hidden-accessible")){a=$(b).attr("id");var c=$(b).attr("data-smartcbo");a&&c&&(a=eval(GibberishAES.dec(decodeURIComponent(c),a)),$(b).select2(a))}})}function GetSmartCBOValue(a,b){if(!a)return null;var c=a;"object"!=typeof a&&(c=$("#"+a));if(!$(c).length)return null;a=$(c).val()||"";return"object"!=typeof a||1==b||1==b?a:a=a.join(",")}
function GetSmartCBOText(a,b){if(!a)return null;var c=a;"object"!=typeof a&&(c=$("#"+a));if(!$(c).length)return null;a=$(c).select2("data");if("object"!=typeof a)return null;c=null;for(var d=0;d<a.length;d++)1==b||1==b?(null==c&&(c={}),c[d]=a[d].name):c=(null==c?"":c+",")+a[d].name;return c}
...
function CreateCkEditor(a,b,c,d,e,f){if(c)for(b=b.split(","),c=0;c<b.length;c++)CreateCkEditor(a,b[c],!1,d,e,f);else if(b&&0!=b.length){a=window.ckei_list;if(void 0==a||null==a||"object"!=typeof a)a=[];d="object"==typeof d?d:{};e&&(d.width=e);f&&(d.height=f);CKEDITOR.replace(b,d);-1==$.inArray(b,a)&&a.push(b);window.ckei_list=a}}
function DestroyCkEditors(a,b){if(b&&0!=b.length&&(a=$("#"+b))){var c=window.ckei_list;if(void 0!=c&&null!=c&&"object"==typeof c&&0!=c.length){b=[];for(var d={$jscomp$loop$prop$i$8:0};d.$jscomp$loop$prop$i$8<c.length;d={$jscomp$loop$prop$i$8:d.$jscomp$loop$prop$i$8,$jscomp$loop$prop$dropped$9:d.$jscomp$loop$prop$dropped$9},d.$jscomp$loop$prop$i$8++)d.$jscomp$loop$prop$dropped$9=!1,a.find("#"+c[d.$jscomp$loop$prop$i$8]).each(function(a){return function(){var b=CKEDITOR.instances[c[a.$jscomp$loop$prop$i$8]];
b&&b.destroy(!0);a.$jscomp$loop$prop$dropped$9=!0}}(d)),d.$jscomp$loop$prop$dropped$9||b.push(c[d.$jscomp$loop$prop$i$8]);window.ckei_list=b}}}
...
b.files[0].name),eval(a))},fail:function(a,b){ShowErrorDialog("Upload failed: "+b.errorThrown+" (Status: "+b.textStatus+")")}})}else return!1}function TreeGridViewAction(a,b,c,d,e){e||(e=b);0!=d&&1!=d&&(d=1==$(a).val()?0:1);e==b&&$(a).val(d);$("table#"+c+" > tbody > tr.clsTreeGridChildOf"+b).each(function(f){1==d?$(this).show():$(this).hide();a=$(this).find("input.clsTreeGridBtn").first();"object"==typeof a&&(b=$(this).attr("data-id"))&&TreeGridViewAction(a,b,c,1==d?$(a).val():0,e)})}
function RepeatControl(a,b){if(!a||!b)return!1;var c=$(a).parent().find("[data-tid='"+b+"']").last();if(0>=c.length)return!1;var d=Number(c.attr("data-ti"));b=b+"-"+(d+1);c=c.clone();c.hasClass("clsSubForm")&&c.find(".postable").each(function(){var a=$(this).attr("id");a&&(a=a.substring(0,a.lastIndexOf("-"))+"-"+(d+1),$(this).attr("id",a),$(this).val(""))});c.attr("data-ti",d+1);c.attr("id",b);c.val("");c.addClass("ctrl-clone");c.insertBefore($(a));c=$(a).attr("data-ract");$('<button class="clsRepeatableCtrlBtn remove-ctrl-btn" onclick="RemoveRepeatableControl(this,\''+
b+'\')"><i class="fa fa-minus-circle" aria-hidden="true"></i>'+(c?c:"")+"</button>").insertBefore($(a))}function RemoveRepeatableControl(a,b){if(!b)return!1;$("#"+b).remove();$(a).remove()};
