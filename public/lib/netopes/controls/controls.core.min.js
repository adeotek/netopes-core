...
(function(a){a.fn.imageCheckBoxCheck=function(){a(this).val(1);a(this).trigger("change");return this};a.fn.imageCheckBoxUncheck=function(){a(this).val(0);a(this).trigger("change");return this};a.fn.imageCheckBoxToggle=function(){"1"===a(this).val()?a(this).val(0):a(this).val(1);a(this).trigger("change");return this}})(jQuery);
