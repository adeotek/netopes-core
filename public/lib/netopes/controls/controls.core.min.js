...
debugLevel:0,source:{url:h+"&type=json&tree=1"},lazyLoad:function(a,b){b.result={url:h+"&type=json&tree=1",data:{key:b.node.key}}},createNode:function(a,b){if(!b.node.data.hasSelectedChild)return!1;$.ajax({url:h+"&type=json&tree=1",data:{key:b.node.key},dataType:"json",success:function(a){b.node.addChildren(a)}})}})}}
