...
$(document).on("keydown",".clsOnEnterActionButton",function(a){13==a.keyCode&&(a=$(this).attr("data-onenterbtn"))&&($(this).trigger("focusout"),$("#"+a).click())});function AddClassOnErrorByParent(a,b,c){var d=c?c:"clsFieldError";b?$("#"+a+" .clsRequiredField").removeClass(d):$("#"+a+" .clsRequiredField").each(function(){$(this).val()?$(this).removeClass(d):$(this).addClass(d)})}function AddClassOnError(a,b,c){c=c?c:"clsFieldError";b?$("#"+a).removeClass(c):$("#"+a).addClass(c)}
function AddClassOnErrorByName(a,b,c,d){var e=d?d:"clsFieldError";c?$("#"+a+' [name="'+b+'"]').removeClass(e):$("#"+a+' [name="'+b+'"]').each(function(){$(this).val()?$(this).removeClass(e):$(this).addClass(e)})}function CheckIfEnter(a){a&&a.which?a=a.which:(a=event,a=a.keyCode);return 13==a?!0:!1}$(document).on("keydown",".clsSetNoNumericValidation",function(a){var b=a.which||a.keyCode||a.charCode||0;(48<=b&&57>=b||96<=b&&105>=b)&&a.preventDefault()});
