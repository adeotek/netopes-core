var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(c,k,a){c instanceof String&&(c=String(c));for(var b=c.length,d=0;d<b;d++){var e=c[d];if(k.call(a,e,d,c))return{i:d,v:e}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(c,k,a){c!=Array.prototype&&c!=Object.prototype&&(c[k]=a.value)};$jscomp.getGlobal=function(c){return"undefined"!=typeof window&&window===c?c:"undefined"!=typeof global&&null!=global?global:c};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(c,k,a,b){if(k){a=$jscomp.global;c=c.split(".");for(b=0;b<c.length-1;b++){var d=c[b];d in a||(a[d]={});a=a[d]}c=c[c.length-1];b=a[c];k=k(b);k!=b&&null!=k&&$jscomp.defineProperty(a,c,{configurable:!0,writable:!0,value:k})}};$jscomp.polyfill("Array.prototype.find",function(c){return c?c:function(c,a){return $jscomp.findInternal(this,c,a).v}},"es6","es3");
(function(c){"function"===typeof define&&define.amd?define(["jquery","jquery-ui/ui/widget"],c):"object"===typeof exports?c(require("jquery"),require("./vendor/jquery.ui.widget")):c(window.jQuery)})(function(c){function k(a){var b="dragover"===a;return function(d){d.dataTransfer=d.originalEvent&&d.originalEvent.dataTransfer;var e=d.dataTransfer;e&&-1!==c.inArray("Files",e.types)&&!1!==this._trigger(a,c.Event(a,{delegatedEvent:d}))&&(d.preventDefault(),b&&(e.dropEffect="copy"))}}c.support.fileInput=
...
a.split("-"))&&1<a.length&&parseInt(a[1],10))&&a+1},_chunkedUpload:function(a,b){a.uploadedBytes=a.uploadedBytes||0;var d=this,e=a.files[0],f=e.size,g=a.uploadedBytes,l=a.maxChunkSize||f,h=this._blobSlice,u=c.Deferred(),n=u.promise(),m;if(!(this._isXHRUpload(a)&&h&&(g||("function"===c.type(l)?l(a):l)<f))||a.data)return!1;if(b)return!0;if(g>=f)return e.error=a.i18n("uploadedBytes"),this._getXHRPromise(!1,a.context,[null,"error",e.error]);var k=function(){var b=c.extend({},a),n=b._progress.loaded;b.blob=
h.call(e,g,g+("function"===c.type(l)?l(b):l),e.type);b.chunkSize=b.blob.size;b.contentRange="bytes "+g+"-"+(g+b.chunkSize-1)+"/"+f;d._trigger("chunkbeforesend",null,b);d._initXHRData(b);d._initProgressListener(b);m=(!1!==d._trigger("chunksend",null,b)&&c.ajax(b)||d._getXHRPromise(!1,b.context)).done(function(e,l,h){g=d._getUploadedBytes(h)||g+b.chunkSize;n+b.chunkSize-b._progress.loaded&&d._onProgress(c.Event("progress",{lengthComputable:!0,loaded:g-b.uploadedBytes,total:g-b.uploadedBytes}),b);a.uploadedBytes=
b.uploadedBytes=g;b.result=e;b.textStatus=l;b.jqXHR=h;d._trigger("chunkdone",null,b);d._trigger("chunkalways",null,b);g<f?k():u.resolveWith(b.context,[e,l,h])}).fail(function(a,c,e){b.jqXHR=a;b.textStatus=c;b.errorThrown=e;d._trigger("chunkfail",null,b);d._trigger("chunkalways",null,b);u.rejectWith(b.context,[a,c,e])}).always(function(){d._deinitProgressListener(b)})};this._enhancePromise(n);n.abort=function(){return m.abort()};k();return n},_beforeSend:function(a,b){0===this._active&&(this._trigger("start"),
...
b);var d=this,e,f,g=d._getAJAXSettings(b),l=function(){d._sending+=1;g._bitrateTimer=new d._BitrateTimer;return e=e||((f||!1===d._trigger("send",c.Event("send",{delegatedEvent:a}),g))&&d._getXHRPromise(!1,g.context,f)||d._chunkedUpload(g)||c.ajax(g)).done(function(a,b,c){d._onDone(a,b,c,g)}).fail(function(a,b,c){d._onFail(a,b,c,g)}).always(function(a,b,c){d._deinitProgressListener(g);d._onAlways(a,b,c,g);--d._sending;--d._active;if(g.limitConcurrentUploads&&g.limitConcurrentUploads>d._sending)for(a=
d._slots.shift();a;){if("pending"===d._getDeferredState(a)){a.resolve();break}a=d._slots.shift()}0===d._active&&d._trigger("stop")})};this._beforeSend(a,g);if(this.options.sequentialUploads||this.options.limitConcurrentUploads&&this.options.limitConcurrentUploads<=this._sending){if(1<this.options.limitConcurrentUploads){var h=c.Deferred();this._slots.push(h);b=h.then(l)}else b=this._sequence=this._sequence.then(l,l);b.abort=function(){f=[void 0,"abort","abort"];return e?e.abort():(h&&h.rejectWith(g.context,
f),l())};return this._enhancePromise(b)}return l()},_onAdd:function(a,b){var d=this,e=!0,f=c.extend({},this.options,b),g=b.files,l=g.length,h=f.limitMultiFileUploads,k=f.limitMultiFileUploadSize,n=f.limitMultiFileUploadSizeOverhead,m=0,r=this._getParamName(f),t=0;if(!l)return!1;k&&void 0===g[0].size&&(k=void 0);if((f.singleFileUploads||h||k)&&this._isXHRUpload(f))if(f.singleFileUploads||k||!h)if(!f.singleFileUploads&&k){var p=[];var q=[];for(f=0;f<l;f+=1)if(m+=g[f].size+n,f+1===l||m+g[f+1].size+n>
k||h&&f+1-t>=h)p.push(g.slice(t,f+1)),m=r.slice(t,f+1),m.length||(m=r),q.push(m),t=f+1,m=0}else q=r;else for(p=[],q=[],f=0;f<l;f+=h)p.push(g.slice(f,f+h)),m=r.slice(f,f+h),m.length||(m=r),q.push(m);else p=[g],q=[r];b.originalFiles=g;c.each(p||g,function(f,g){var h=c.extend({},b);h.files=p?g:[g];h.paramName=q[f];d._initResponseObject(h);d._initProgressObject(h);d._addConvenienceMethods(a,h);return e=d._trigger("add",c.Event("add",{delegatedEvent:a}),h)});return e},_replaceFileInput:function(a){var b=
...
h=function(){k.readEntries(function(a){a.length?(f=f.concat(a),h()):l(f)},g)};b=b||"";if(a.isFile)a._file?(a._file.relativePath=b,e.resolve(a._file)):a.file(function(a){a.relativePath=b;e.resolve(a)},g);else if(a.isDirectory){var k=a.createReader();h()}else e.resolve([]);return e.promise()},_handleFileTreeEntries:function(a,b){var d=this;return c.when.apply(c,c.map(a,function(a){return d._handleFileTreeEntry(a,b)})).then(function(){return Array.prototype.concat.apply([],arguments)})},_getDroppedFiles:function(a){a=
