	...
	public function __construct(array $params) {
		...
		foreach($params['layouts'] as $layout) {
			...
			if(array_key_exists('with_borders',$layout) && $layout['with_borders']) {
				...
				$this->default_formats['border_std'] =  array('borders'=>array('allBorders'=>array('borderStyle'=>\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,'color'=>array('rgb'=>'000000'))));
				if(array_key_exists('with_outer_border',$layout) && $layout['with_outer_border']) {
					$this->default_formats['border_out'] = array('borders'=>array('outline'=>array('borderStyle'=>\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_MEDIUM,'color'=>array('rgb'=>'000000'))));
				}//if(array_key_exists('with_outer_border',$layout) && $layout['with_outer_border'])
			}//if(array_key_exists('with_borders',$layout) && $layout['with_borders'])
