 ...
 */
interface ICollection extends Traversable,Countable,JsonSerializable,IteratorAggregate,ArrayAccess {
    /**
     ...
     * @return ICollection[] An array with two elements. The first element contains the collection
