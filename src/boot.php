...
$custom_error_handler = \NETopes\Core\AppConfig::GetValue('error_handler_class');
if(strlen($custom_error_handler) && class_exists($custom_error_handler) && array_key_exists('NETopes\Core\App\IErrorHandler',class_implements($custom_error_handler))) {
    ...
    $custom_error_handler::SetErrorLogFile(\NETopes\Core\AppConfig::GetValue('errors_log_file'));
    $custom_error_handler::SetErrorLogPath(_NAPP_ROOT_PATH._NAPP_APPLICATION_PATH.\NETopes\Core\AppConfig::GetValue('logs_path').'/');
    ...
    ErrorHandler::SetErrorLogFile(\NETopes\Core\AppConfig::GetValue('errors_log_file'));
    ErrorHandler::SetErrorLogPath(_NAPP_ROOT_PATH._NAPP_APPLICATION_PATH.\NETopes\Core\AppConfig::GetValue('logs_path').'/');
