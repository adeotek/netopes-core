		...
		protected function SetControl() {
			...
			if($pages_no>1) {
				switch($this->theme_type) {
					case 'bootstrap3':
						if($cpage==1 || $cpage<0) {
							$result .= "\t".'<div class="btn btn-default btn-xxs ionly"><i class="fa fa-angle-double-left"></i></div>'."\n";
							$result .= "\t".'<div class="btn btn-default btn-xxs ionly"><i class="fa fa-angle-left"></i></div>'."\n";
						} else {
							$lonclick = $this->AreqRun('{{page}}',1);
							$result .= "\t".'<div class="btn btn-info btn-xxs ionly" onclick="'.$lonclick.'"><i class="fa fa-angle-double-left"></i></div>'."\n";
						...
						if($cpage==$pages_no || $cpage<0) {
							...
							$result .= "\t".'<div class="btn btn-default btn-xxs ionly"><i class="fa fa-angle-double-right"></i></div>'."\n";
						} else {
							$lonclick = $this->AreqRun('{{page}}',($cpage+1));
							$result .= "\t".'<div class="btn btn-info btn-xxs ionly" onclick="'.$lonclick.'"><i class="fa fa-angle-right"></i></div>'."\n";
							$lonclick = $this->AreqRun('{{page}}',$pages_no);
							$result .= "\t".'<div class="btn btn-info btn-xxs ionly" onclick="'.$lonclick.'"><i class="fa fa-angle-double-right"></i></div>'."\n";
						}//if($cpage==$pages_no || $cpage<0)
						break;
					default:
						if($cpage==1 || $cpage<0) {
							$result .= "\t".'<span class="pag-btn"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-angle-double-left fa-inverse fa-stack-1x"></i></span></span>'."\n";
							$result .= "\t".'<span class="pag-btn"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-angle-left fa-inverse fa-stack-1x"></i></span></span>'."\n";
						} else {
							$lonclick = $this->AreqRun('{{page}}',1);
							$result .= "\t".'<span class="pag-btn active" onclick="'.$lonclick.'"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-angle-double-left fa-inverse fa-stack-1x"></i></span></span>'."\n";
							$lonclick = $this->AreqRun('{{page}}',($cpage-1));
						...
						if($cpage==$pages_no || $cpage<0) {
							...
							$result .= "\t".'<span class="pag-btn"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-angle-double-right fa-inverse fa-stack-1x"></i></span></span>'."\n";
						} else {
							$lonclick = $this->AreqRun('{{page}}',($cpage+1));
							$result .= "\t".'<span class="pag-btn active" onclick="'.$lonclick.'"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-angle-right fa-inverse fa-stack-1x"></i></span></span>'."\n";
							$lonclick = $this->AreqRun('{{page}}',$pages_no);
							$result .= "\t".'<span class="pag-btn active" onclick="'.$lonclick.'"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-angle-double-right fa-inverse fa-stack-1x"></i></span></span>'."\n";
						}//if($cpage==$pages_no || $cpage<0)
						break;
				}//END switch
			} else {
