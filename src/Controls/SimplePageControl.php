...
class SimplePageControl extends Control {
	...
	protected function SetControl() {
		...
		if($pages_no>1) {
		    if($cpage==1 || $cpage<0) {
                $result .= "\t".'<div class="'.(is_object(NApp::$theme) ? NApp::$theme->GetButtonClass(THEME_BTN_DEFAULT,'btn-xxs ionly') : 'btn btn-default btn-xxs ionly').'"><i class="fa fa-angle-double-left"></i></div>'."\n";
                $result .= "\t".'<div class="'.(is_object(NApp::$theme) ? NApp::$theme->GetButtonClass(THEME_BTN_DEFAULT,'btn-xxs ionly') : 'btn btn-default btn-xxs ionly').'"><i class="fa fa-angle-left"></i></div>'."\n";
            } else {
                $lonclick = $this->AreqRun('{{page}}',1);
                $result .= "\t".'<div class="'.(is_object(NApp::$theme) ? NApp::$theme->GetButtonClass(THEME_BTN_INFO,'btn-xxs ionly') : 'btn btn-info btn-xxs ionly').'" onclick="'.$lonclick.'"><i class="fa fa-angle-double-left"></i></div>'."\n";
                $lonclick = $this->AreqRun('{{page}}',($cpage-1));
                $result .= "\t".'<div class="'.(is_object(NApp::$theme) ? NApp::$theme->GetButtonClass(THEME_BTN_INFO,'btn-xxs ionly') : 'btn btn-info btn-xxs ionly').'" onclick="'.$lonclick.'"><i class="fa fa-angle-left"></i></div>'."\n";
            }//if($cpage==1 || $cpage<0)
            ...
            if($cpage==$pages_no || $cpage<0) {
                $result .= "\t".'<div class="'.(is_object(NApp::$theme) ? NApp::$theme->GetButtonClass(THEME_BTN_DEFAULT,'btn-xxs ionly') : 'btn btn-default btn-xxs ionly').'"><i class="fa fa-angle-right"></i></div>'."\n";
                $result .= "\t".'<div class="'.(is_object(NApp::$theme) ? NApp::$theme->GetButtonClass(THEME_BTN_DEFAULT,'btn-xxs ionly') : 'btn btn-default btn-xxs ionly').'"><i class="fa fa-angle-double-right"></i></div>'."\n";
            } else {
                $lonclick = $this->AreqRun('{{page}}',($cpage+1));
                $result .= "\t".'<div class="'.(is_object(NApp::$theme) ? NApp::$theme->GetButtonClass(THEME_BTN_INFO,'btn-xxs ionly') : 'btn btn-info btn-xxs ionly').'" onclick="'.$lonclick.'"><i class="fa fa-angle-right"></i></div>'."\n";
                $lonclick = $this->AreqRun('{{page}}',$pages_no);
                $result .= "\t".'<div class="'.(is_object(NApp::$theme) ? NApp::$theme->GetButtonClass(THEME_BTN_INFO,'btn-xxs ionly') : 'btn btn-info btn-xxs ionly').'" onclick="'.$lonclick.'"><i class="fa fa-angle-double-right"></i></div>'."\n";
            }//if($cpage==$pages_no || $cpage<0)
		} else {
